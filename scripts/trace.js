/**
 * $Id: trace.js v0.1 2023-08-28 21:36:41 3.30GB .m0rph $
 * 
 * @param {NS} ns
 */
import {exit, trace} from '/modules/helpers.js';
...
export async function main(ns) {
   ...
   let [found, path] = trace(ns, 'home', '', ns.args[0]);
   for (let host of path) ns.tprintf(host);
}
