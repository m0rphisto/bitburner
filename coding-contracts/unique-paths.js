/**
 * $Id: unique-paths.js v0.2 2023-09-06 03:37:15 3.00GB .m0rph $
 * 
 * description:
...
export async function main(ns) {
    ...
    const
       ...
       cdata = ns.codingcontract.getData(cc.file),
       get_paths = (rows, cols) => {
        let i, k, grid = [[]];
    ...
    ns.codingcontract.attempt(get_paths(cdata[0], cdata[1]), cc.file, cc.host);
}